    ...
    <div>
        ...
        <div id="ContentBody">
            <asp:CreateUserWizard runat="server" ID="CreateUserWizard1" AutoGeneratePassword="False"
                    ...
                    <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2">
                                ...
                                <tr>
                                    <td class="fieldname">
                                        <asp:Label runat="server" ID="lblEmail" AssociatedControlID="Email" Text="E-mail:" />
                                    </td>
                                    <td>
                                        <asp:TextBox runat="server" ID="Email" Width="100%" Text='<%= Email %>'></asp:TextBox>
                                    </td>
                                    <td>
                ...
                <MailDefinition BodyFileName="~/RegistrationMail.txt" From="clove@extremewebworks.com"
