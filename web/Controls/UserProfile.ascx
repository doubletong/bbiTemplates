<%@ Control Language="C#" AutoEventWireup="false" CodeFile="UserProfile.ascx.cs" Inherits="UserProfile" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>

<%@ Register Assembly="BBICMSBLL" Namespace="BBICMS.Web.UI" TagPrefix="cc1" %>
<div class="sectionsubtitle">
    Site preferences</div>
<br />
<table cellpadding="2">
    <tr>
        <td class="fieldname">
            <asp:Label runat="server" ID="lblNewsletter" AssociatedControlID="ddlSubscriptions"
                Text="Newsletter:" />
        </td>
        <td>
    ...
    <tr>
        <td class="fieldname">
            <asp:Label runat="server" ID="lblLanguage" AssociatedControlID="ddlLanguages" Text="Language:" />
        </td>
        <td>
...
<table cellpadding="2" width="95%">
    ...
    <tr>
        <td style="width: 110px;" class="fieldname">
            <asp:Label runat="server" ID="lblAvatarUrl" AssociatedControlID="txtAvatarUrl" Text="Avatar Url:" />
        </td>
        <td>
            <asp:TextBox runat="server" ID="txtAvatarUrl" Width="99%" />
        </td>
    </tr>
    <tr>
        <td class="fieldname">
            <asp:Label runat="server" ID="lblSignature" AssociatedControlID="txtSignature" Text="Signature:" />
        </td>
        <td>
            <asp:TextBox runat="server" ID="txtSignature" Width="99%" MaxLength="500" TextMode="multiLine"
                Rows="4" />
        </td>
    </tr>
</table>
...
<table cellpadding="2">
    <tr>
        ...
        <td style="width: 400px;">
            <asp:TextBox ID="txtFullName" runat="server" Width="99%"></asp:TextBox>
        </td>
    </tr>
   
    <tr>
        <td class="fieldname">
            <asp:Label runat="server" ID="lblGender" AssociatedControlID="ddlGenders" Text="Gender:" />
        </td>
        <td>
    ...
    <tr>
        <td class="fieldname">
            <asp:Label runat="server" ID="lblBirthDate" AssociatedControlID="txtBirthDate" Text="Birth date:" />
        </td>
        <td>
    ...
    <tr>
        <td class="fieldname">
            <asp:Label runat="server" ID="lblOccupation" AssociatedControlID="ddlOccupations"
                Text="Occupation:" />
        </td>
        <td>
    ...
    <tr>
        <td class="fieldname">
            <asp:Label runat="server" ID="lblWebsite" AssociatedControlID="txtWebsite" Text="Website:" />
        </td>
        <td>
            <asp:TextBox ID="txtWebsite" runat="server" Width="99%"></asp:TextBox>
        </td>
    </tr>
</table>
<p>
...
<table cellpadding="2">
    ...
    <tr>
        ...
        <td>
            ...
            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender4" runat="server" TargetControlID="txtFax"
                Mask="(999)999-9999" MaskType="Number" ClearMaskOnLostFocus="false">
            </ajaxToolkit:MaskedEditExtender>
        </td>
    </tr>
