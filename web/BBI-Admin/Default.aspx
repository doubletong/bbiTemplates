<%@ Page Language="C#" MasterPageFile="~/BBI-Admin/Admin.master"  AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Admin_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminContent" runat="Server">
    <div class="container-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <div id="breadcrumbs">
                        <div class="breadcrumb-button blue">
                            <span class="breadcrumb-label"><i class="icon-home icon-fixed-width"></i>首页</span>
                        ...
                        <div class="breadcrumb-button">
                            <span class="breadcrumb-label">
                                <i class="icon-dashboard icon-fixed-width"></i>控制面版
                            </span>
                            <span class="breadcrumb-arrow"><span></span></span>
                        </div>
                    </div>
                    ...
                    <div class="span12">
                        ...
                        <ul class="chat-box timeline">
                            ...
                            <li class="arrow-box-left gray">
                                <div class="avatar">
                                    <img class="avatar-small" src="/Content/Public/images/avatars/avatar1.jpg" /></div>
                                <div class="info">
                                    <span class="name">
        ...
        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                            ...
                            <li class="arrow-box-left gray">
                                <div class="avatar">
                                    <img class="avatar-small" src="/content/public/images/avatars/avatar2.jpg" /></div>
                                <div class="info">
                                    <span class="name">
                            ...
                            <li class="arrow-box-left gray">
                                <div class="avatar">
                                    <img class="avatar-small" src="/content/public/images/avatars/avatar3.jpg" /></div>
                                <div class="info">
                                    <span class="name">
                                    ...
                                    <ul class="thumbnails padded">
                                        ...
                                        <li class="span3">
                                            <a href="#" class="thumbnail">
                                                <img src="http://img.heiniaozhi.cn/240x100" alt="">
                                            </a>
                                        </li>
                        ...
                        <div class="box closable-chat-box">
                            <div class="box-content padded">
                                ...
                                <form class="fill-up" action="http://beer2code.com/">
