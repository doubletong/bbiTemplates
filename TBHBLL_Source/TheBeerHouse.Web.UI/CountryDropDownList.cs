namespace TheBeerHouse.Web.UI
{
    ...
    public class CountryDropDownList : DropDownList
    {
        ...
        {
            this.Items.Clear();
            this.Items.Add(new ListItem("Choose a Country", "0"));
            ...
            this.Items.Add(new ListItem("Cocos (Keeling) Islands", "CC"));
            ...
            this.Items.Add(new ListItem("Cote D'Ivoire (Ivory Coast)", "CI"));
            ...
            this.Items.Add(new ListItem("East Timor", "TP"));
            ...
            this.Items.Add(new ListItem("Gaza", "GZ"));
            ...
            this.Items.Add(new ListItem("Heard and McDonald Islands", "HM"));
            ...
            this.Items.Add(new ListItem("Iran", "IR"));
            ...
            this.Items.Add(new ListItem("Laos", "LA"));
            ...
            this.Items.Add(new ListItem("Libya", "LY"));
            ...
            this.Items.Add(new ListItem("Macau", "MO"));
            this.Items.Add(new ListItem("Macedonia", "MK"));
            ...
            this.Items.Add(new ListItem("Slovak Republic", "SK"));
            ...
            this.Items.Add(new ListItem("US Minor Outlying Islands", "UM"));
            this.Items.Add(new ListItem("Uzbekistan", "UZ"));
            this.Items.Add(new ListItem("Vanuatu", "VU"));
            this.Items.Add(new ListItem("Vatican City State (Holy See)", "VA"));
            ...
            this.Items.Add(new ListItem("Wallis and Futuna Islands", "WF"));
            this.Items.Add(new ListItem("West Bank", "WB"));
            this.Items.Add(new ListItem("Western Sahara", "EH"));
            this.Items.Add(new ListItem("Yemen", "YE"));
            this.Items.Add(new ListItem("Yugoslavia", "YU"));
            this.Items.Add(new ListItem("Zaire", "ZR"));
